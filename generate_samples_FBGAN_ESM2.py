...
class WGAN_LangGP():
    def __init__(self, batch_size=64, lr=0.0001, num_epochs=150, seq_len = 156, data_dir='./data/dna_uniprot_under_50_reviewed.fasta', \
        ...
        self.checkpoint_dir = './checkpoint_FBGAN_ESM2/' + run_name + "/"
...
def main():
    ...
    parser.add_argument("--run_name", default="FBGAN_ESM2", help="Name for output files")
    parser.add_argument("--load_dir", default="./checkpoint_FBGAN_ESM2/", help="Load pretrained GAN checkpoints")
    parser.add_argument("--output_file", default="generated_samples_FBGAN_ESM2.txt", help="Output file to save generated samples")
