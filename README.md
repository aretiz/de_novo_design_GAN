...
- To plot the average physiochemical values you need to first run the [$CAMP_{R4} server$](https://camp.bicnirrh.res.in/predict/) and select the peptides with $P(\text{AMP}) \geq 0.8$.
