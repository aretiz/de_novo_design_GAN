...
def main():
    parser = argparse.ArgumentParser(description='MLP with FB.')
    parser.add_argument("--run_name", default= "fbgan_amp_demo_ESM2", help="Name for output files")
    parser.add_argument("--load_dir", default="./checkpoint/fbgan_amp_demo_ESM2/", help="Load pretrained GAN checkpoints")
