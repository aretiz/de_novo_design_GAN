...
def main():
    ...
    parser.add_argument("--run_name", default= "fbgan_amp_demo_GUPTA", help="Name for output files")
    parser.add_argument("--load_dir", default="./checkpoint/fbgan_amp_demo_GUPTA", help="Load pretrained GAN checkpoints")
